        ...
        <ContainerWithBackground>
          <Navbar>
            ...
            <NavLinks>
              ...
              <NavLink onClick={() => scrollToSection(sWorkflowsRef)}>
                Smart Workflows
              </NavLink>
            ...
            <SectionText style={{ fontSize: "1.3rem", display: "flex" }}>
              <div>
                ...
                >
                  <NavLink
                    className={
                      "animate__tada animate__animated animate__infinite animate__slow"
                    }
                    onClick={() => {
                      window.location.href = "https://workflows.valortech.de/";
                    }}
                  ...
                  <video
                    style={{ width: "100%" }}
                    src={"assets/workspace-feature.mov"}
                    autoPlay={true}
                    loop={true}
                    muted={true}
                  />
                  <p>
                    The motivation behind creating the platform is to help
                    people develop BPMN diagrams faster. We also allow people to
                    share their work with other users. Check it out right now!
                    You can always find it at
                  </p>
                  <a href={"https://workflows.valortech.de/"}>
                    workflows.valortech.de/
                  </a>
                  <p>
                    I can see that you are very interested in this project now
                    that you are here. There is one thing I can tell you in
                    confidence, but don't tell anyone.
                  </p>
                  <video
                    style={{ width: "100%" }}
                    src={"assets/ai-feature.mov"}
                    autoPlay={true}
                    loop={true}
                    muted={true}
                  />
                  ...
                  <p>
                    "Yeah, yeah, another new chatbot," you may think. But have
                    you ever drawn BPMN diagrams? It can take quite a long time.
